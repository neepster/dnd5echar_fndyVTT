...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_basics_tab(self) -> QtWidgets.QWidget:
        ...
        self.copy_button_basics = QtWidgets.QPushButton(" Copy Statblock")
        self.copy_button_basics.setIcon(self.style().standardIcon(QtWidgets.QStyle.SP_FileDialogDetailedView))
        self.quit_button_basics = QtWidgets.QPushButton(" Quit")
        self.quit_button_basics.setIcon(self.style().standardIcon(QtWidgets.QStyle.SP_DialogCloseButton))
        buttons_layout.addWidget(self.randomize_button)
        buttons_layout.addWidget(self.clear_button)
        buttons_layout.addWidget(self.copy_button_basics)
        buttons_layout.addWidget(self.quit_button_basics)
    ...
    def _connect_signals(self) -> None:
        ...
        self.copy_button_basics.clicked.connect(self._copy_statblock)
        self.quit_button_basics.clicked.connect(self._on_quit_clicked)
